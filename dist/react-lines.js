(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("@fortawesome/free-solid-svg-icons"), require("@fortawesome/react-fontawesome"), require("prop-types"));
	else if(typeof define === 'function' && define.amd)
		define("react-lines", ["react", "@fortawesome/free-solid-svg-icons", "@fortawesome/react-fontawesome", "prop-types"], factory);
	else if(typeof exports === 'object')
		exports["react-lines"] = factory(require("react"), require("@fortawesome/free-solid-svg-icons"), require("@fortawesome/react-fontawesome"), require("prop-types"));
	else
		root["react-lines"] = factory(root["react"], root["@fortawesome/free-solid-svg-icons"], root["@fortawesome/react-fontawesome"], root["prop-types"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_11__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__fortawesome_react_fontawesome__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__fortawesome_free_solid_svg_icons___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__fortawesome_free_solid_svg_icons__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_react_draggable__ = __webpack_require__(1);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_react_progress_line__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_react_progress_line___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_react_progress_line__);
...
function (_React$Component) {
  ...
  function ReactLines() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ReactLines).call(this));
    _this.handleMovement = _this.handleMovement.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.handleClick = _this.handleClick.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.generateNode = _this.generateNode.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.insertLine = _this.insertLine.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.Nodes = _this.Nodes.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.Lines = _this.Lines.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.state = {
      active: false,
      show: false,
      message: null,
  ...
  _createClass(ReactLines, [{
    ...
    value: function handleMovement(e, data) {
      ...
      var updated_coordinates = _toConsumableArray(this.state.coordinates);
    ...
    value: function handleClick(e) {
      ...
      if (!this.state.first_node_in_line) {
        ...
        var connections = _objectSpread({}, this.state.lines);

        if (typeof connections["".concat(node)] === "undefined" || connections["".concat(node)] === null || connections["".concat(node)].length === null || connections["".concat(node)].length === 0) {
          connections["".concat(node)] = [];
        }
        ...
        var _connections = _objectSpread({}, this.state.lines);

        console.log({
          connections: _connections
        });

        _connections["".concat(this.state.first_node_in_line)].push(node);
    ...
    value: function generateNode() {
      ...
      var node = Math.random().toString(36).substr(2, 6); // second = Math.random()
      // 	.toString(36)
      // 	.substr(2, 6);

      console.log("gen: ", node);
      this.setState({
        nodes: _toConsumableArray(this.state.nodes).concat([node]),
        active: true
      });
    }
  }, {
    ...
    value: function Nodes() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_0_react___default.a.Fragment, null, nodes.map(function (node) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_react_draggable___default.a, {
          onDrag: _this2.handleMovement,
          key: node,
          ...
          className: "shrink"
        }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__fortawesome_react_fontawesome__["FontAwesomeIcon"], {
          id: node,
          icon: __WEBPACK_IMPORTED_MODULE_2__fortawesome_free_solid_svg_icons__["faDesktop"],
          size: "3x",
          style: {
    ...
    value: function Lines() {
      ...
      var coordinates = _toConsumableArray(this.state.coordinates),
          lines = _objectSpread({}, this.state.lines),
          nodes = _toConsumableArray(this.state.nodes);
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_0_react___default.a.Fragment, null, lines_keys.map(function (node, index) {
        return lines_values[index].map(function (dest) {
          return (// console.log(
            ...
            // ),
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4_react_progress_line___default.a, {
              key: dest,
              x0: coordinates["".concat(nodes.indexOf(node))][0],
              y0: coordinates["".concat(nodes.indexOf(node))][1],
              x1: coordinates["".concat(nodes.indexOf(dest))][0],
              y1: coordinates["".concat(nodes.indexOf(dest))][1],
              borderWidth: 3,
              zIndex: -1
            })
          );
    ...
    key: "render",
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", null, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h1", null, "This is React Lines."), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("button", {
        onClick: this.generateNode
      }, "New Node"), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("button", {
        onClick: this.insertLine
      }, "Draw Line"), this.state.message, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("br", null), "line follows:", __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("br", null), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", null, this.state.show && this.Lines()), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", null, this.state.active && this.Nodes()));
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (ReactLines);
